...
echo "Install dependencies for building Python"
...
echo "Download Python 3.10 source code"
...
echo " Navigate to the Python source directory"
...
echo "Create a symlink from python to python3"
